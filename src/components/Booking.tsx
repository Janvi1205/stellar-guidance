...
const Booking = () => {
  ...
  const inputClass = "w-full px-3 py-2.5 sm:px-4 sm:py-3 md:px-5 md:py-4 rounded-xl bg-card border border-border/50 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all text-sm md:text-base";
  ...
  return (
    <section ref={sectionRef} id="booking" className="section-padding bg-secondary/30">
      ...
      <div className="booking-content max-w-3xl mx-auto text-center">
        ...
        <form onSubmit={handleSubmit} className="mt-8 md:mt-12 space-y-3 md:space-y-5 text-left">
          ...
          <div className="text-center">
            <button type="submit" className="px-6 py-3 md:px-8 md:py-3.5 bg-primary text-primary-foreground font-semibold rounded-full shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 transition-all duration-300 text-sm md:text-base">
              Book Now
            </button>
          </div>
        </form>
