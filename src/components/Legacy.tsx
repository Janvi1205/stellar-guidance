...
const Legacy = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (imgEl) {
        gsap.fromTo(imgEl, { x: 60, opacity: 0 }, {
          x: 0, opacity: 1, duration: 1, ease: "power3.out",
  ...
  return (
    <section ref={sectionRef} id="legacy" className="section-padding bg-background">
      ...
      <div className="max-w-7xl mx-auto">
        <p className="text-primary font-medium tracking-widest uppercase text-sm mb-3 text-center">Our Heritage</p>
        <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground leading-tight text-center mb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="legacy-text order-2 lg:order-1">
            ...
            <h3 className="text-3xl md:text-4xl font-display font-bold bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-600 bg-clip-text text-transparent leading-tight mb-6">
            ...
            <p className="mt-8 text-base italic text-muted-foreground/80 border-l-2 border-accent/50 pl-4">
              "The stars guided him, and through him, they now guide us all."
            </p>
          </div>

          {/* Photo - right on desktop, top on mobile (order-1 on mobile) */}
          <div className="legacy-image order-1 lg:order-2 flex justify-center">
            <div className="relative max-w-sm">
              {/* Sacred glow */}
              <div className="absolute -inset-4 bg-gradient-to-br from-amber-500/20 via-yellow-400/15 to-primary/20 rounded-2xl blur-2xl" />
              {/* Golden border frame */}
              <div className="relative p-1.5 rounded-2xl bg-gradient-to-br from-amber-500/60 via-yellow-400/40 to-amber-600/60 shadow-2xl">
                <img
                  src={grandfatherImg}
